...
@SpringBootTest
public class HappyEatsApplicationTests {
    ...
    public void contextLoads() {
        ...
        login.setUsername("Arijit");
        login.setPassword("abcd1234");

        User user = userDaoImpl.validateUser(login);
        Assert.assertEquals("Arijit",user.getFirstname());
        Assert.assertEquals("Kumar",user.getLastname());
        Assert.assertEquals("jit@gmail.com",user.getEmail());
