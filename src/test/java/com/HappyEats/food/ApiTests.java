package com.HappyEats.food;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.HappyEats.food.controller.CartController;
import com.HappyEats.food.controller.FoodController;
import com.HappyEats.food.controller.LoginController;
import com.HappyEats.food.controller.RegistrationController;
import com.HappyEats.food.dao.CartDaoImpl;
import com.HappyEats.food.dao.FoodDaoImpl;
import com.HappyEats.food.dao.UserDao;
...
public class ApiTests {
    ...
    public void postLoginAPI() throws Exception
    {
        mvc.perform( MockMvcRequestBuilders
                .post("/login")
                .content(asJsonString(new Login("arijit","abcd1234")))
...
*/
    ...
    public void postRegisterAPI() throws Exception
    {
        mvc.perform( MockMvcRequestBuilders
                .post("/register")
                .content(asJsonString(new User("arijit","abcd1234","bbbb","bbbb","b@gmail.com","bbbb","1234",true)))
                .contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk());
    }
    ...
    public void postCheckUsernameApi() throws Exception{
        mvc.perform( MockMvcRequestBuilders
                .post("/checkUserName")
                .content("arijit").contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON)).andExpect(status().isOk());
    }
